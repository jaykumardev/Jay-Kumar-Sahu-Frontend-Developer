...
export default function CapsulesList({ capsules, label }) {
  ...
  return (
    <>
      {capsules?.length !== 0 ? (
                ...
                <div className="flex w-full justify-between space-x-6 p-6">
                  <div className="flex-1 truncate">
                    <div className="flex items-center space-x-3">
                      ...
                      >
                        {capitalizeFirstLowercaseRest(capsule.status)}
                      </span>
                    </div>
        ...
        <div className="py-10 flex items-center justify-center text-white">
          {label}
        </div>
      )}
    </>
